...
.smartcharts-light .chartContainer .stx-panel-study .stx-subholder:after {
  background: #d6d6d6;
  background-image: linear-gradient(to left, #d6d6d6 95%, #ffffff 100%); /* stylelint-disable-line plugin/no-unsupported-browser-features */
}

.smartcharts-dark .chartContainer .stx-panel-study .stx-subholder:after {
  background: #3e3e3e;
  background-image: linear-gradient(to left, #3e3e3e 95%, #0e0e0e 100%); /* stylelint-disable-line plugin/no-unsupported-browser-features */
}
...
.stx-btn-panel:hover span, .stx-btn-panel:active span { /* Make buttons full opacity on hover or hit */
  opacity: 1;
}

.stx-btn-panel:active svg { /* Scale up when active */
...
.stx-panel-control .stx-panel-title { /* Panel/Chart Titles */
  box-shadow: none;
  margin: 0px 4px;
  float: left;
  display: inline-block;
